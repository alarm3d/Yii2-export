...
// Initalize the TBS instance
	$TBS = new OpenTBS; // new instance of TBS
	
	$template = Yii::getAlias('@alarm3d/export').'/templates/OpenTBS.template.docx';
...
class OpenTBS extends \clsTinyButStrong
{
    ...
    public function __construct()
	{
		...
		$this->Plugin(TBS_INSTALL, 'clsOpenTBS'); // load the OpenTBS plugin
